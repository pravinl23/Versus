...
// Wrap the effect for React Three Fiber
const RetroEffect = wrapEffect(RetroEffectImpl)

// Scene component
function Scene({ 
  waveSpeed = 0.02,  // Reduced from 0.05 for slower movement
  waveFrequency = 3,
  waveAmplitude = 0.3,
  ...
  return (
    <>
      ...
      <EffectComposer>
        <RetroEffect pixelSize={pixelSize} colorNum={colorNum} />
      </EffectComposer>
    </>
  )
}
...
const NewLandingPage = () => {
  ...
  return (
    <div className="fullscreen-container">
      <div className="fullscreen-visual-background">
